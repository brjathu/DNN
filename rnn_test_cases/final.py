...
def Inference_2(filePath, X_valid):
    ...
    with tf.Session(config=config) as sess:
        ...
        predict_fc = sess.graph.get_tensor_by_name("rnn/multi_rnn_cell_29/cell_1/dropout/mul:0")
