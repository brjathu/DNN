...
search_path = "/flush1/raj034/RNN/model/test_cases/" + breath + "/" + "quantization_no" + "/"
...
for cases in tests:
    logEntry(str(cases))
    pb_file = search_path + str(cases) + "/pb/RNN_" + breath + "_quantization_no_" + str(cases) + ".pb"
    new_path = "/flush1/raj034/RNN/model/test_cases/" + breath + "/" + quant + "/"
    os.system("mkdir " + new_path + "/" + str(cases))
    os.system("mkdir " + new_path + "/" + str(cases) + "/pb")
    qunatized_pb_file = new_path + str(cases) + "/pb/RNN_" + breath + "_" + quant + "_" + str(cases) + ".pb"
