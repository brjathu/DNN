...
## model 4
hidden_layer1 = tf.layers.dense(tf_x, 2000, tf.nn.relu, name= "hidden_layer1")
dropout1 = tf.layers.dropout(hidden_layer1, rate=0.5, name= "dropout1")
hidden_layer2 = tf.layers.dense(dropout1, 1000, tf.nn.relu, name= "hidden_layer2")
dropout2 = tf.layers.dropout(hidden_layer2, rate=0.5, name= "dropout2")
hidden_layer3 = tf.layers.dense(dropout2, 500, tf.nn.relu, name= "hidden_layer3")
dropout3 = tf.layers.dropout(hidden_layer3, rate=0.5, name= "dropout3")
hidden_layer4 = tf.layers.dense(dropout3, 200, tf.nn.relu, name= "hidden_layer4")
dropout4 = tf.layers.dropout(hidden_layer4, rate=0.5, name= "dropout4")
hidden_layer5 = tf.layers.dense(dropout4, 100, tf.nn.relu, name= "hidden_layer5")
hidden_layer6 = tf.layers.dense(hidden_layer5, 50, tf.nn.relu, name= "hidden_layer6")
hidden_layer7 = tf.layers.dense(hidden_layer6, 10, tf.nn.relu, name= "hidden_layer7")

softmax_layer = tf.nn.softmax(hidden_layer7, name = "softmax")
